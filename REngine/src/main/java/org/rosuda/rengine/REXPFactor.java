...
/**
 * REXPFactor represents a factor in R. It is an integer vector with levels for
 * each contained category.
 */
...
public class REXPFactor extends REXPInteger {
   ...
   *
   * @param factor factor object (can be of any index base, the contents will be
   * pulled with base 1)
   */
  ...
  /**
   * return the contents as a factor - the factor is guaranteed to have index
   * base 1
   *
