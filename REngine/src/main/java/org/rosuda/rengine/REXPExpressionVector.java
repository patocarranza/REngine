...
/**
 * REXPExpressionVector represents a vector of expressions in R. It is
 * essentially a special kind of generic vector - its elements are expected to
 * be valid R expressions.
 */
