...
/**
 * REXPLogical represents a vector of logical values (TRUE, FALSE or NA). Unlike
 * Java's boolean type R's logicals support NA values therefore either of
 * {@link #isTRUE()}, {@link #isFALSE()} or {@link #isNA()} must be used to
 * convert logicals to boolean values.
 */
public class REXPLogical extends REXPVector {
   ...
   * the value used in R since R uses int data type and we use byte. Unlike its
   * real equivalent this one can be used in comparisons, although {@link #isNA(byte)
  ...
  /**
   * create logical vector of the length 1 with the given value as its first
   * (and only) element
   */
  ...
  /**
   * create integer vector with the payload specified by <code>load</code> and
  ...
  /**
   * returns a boolean array of the same langth as the receiver with
   * <code>true</code> for <code>TRUE</code> values and <code>false</code> for
   * <code>FALSE</code> and <code>NA</code> values.
   *
  ...
  /**
   * returns a boolean array of the same langth as the receiver with
   * <code>true</code> for <code>FALSE</code> values and <code>false</code> for
   * <code>TRUE</code> and <code>NA</code> values.
   *
   * @return boolean array
   */
   ...
   *
   * @return boolean array
   * @deprecated replaced by {@link #isTRUE()} for consistency with R
   * nomenclature.
   */
  public boolean[] isTrue() {
    return isTRUE();
