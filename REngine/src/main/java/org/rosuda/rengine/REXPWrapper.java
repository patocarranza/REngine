 ...
 *
 * This facilitates wrapping native java objects and arrays into REXP objects
 * that can be pushed to R
 *
...
public class REXPWrapper {
   ...
   * @return REXP object that represents o or null if the conversion is not
   * possible
   */
